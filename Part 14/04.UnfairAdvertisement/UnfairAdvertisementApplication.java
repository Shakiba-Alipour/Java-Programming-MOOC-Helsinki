...
public class UnfairAdvertisementApplication extends Application {
    ...
    public void start(Stage window) {
        ...
        speeds.getData().add(new XYChart.Data("NDA", 77.1));
        speeds.getData().add(new XYChart.Data("Fastie", 77.1));
        speeds.getData().add(new XYChart.Data("SuperNet", 77.4));
        speeds.getData().add(new XYChart.Data("Meganet", 77.2));
